...
{
    //working
    public class OnCreateChangeRequestActionFilter : ActionFilterAttribute
    {
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            ...
            Scheduling.Email.Utility.SendNotificationEmailBasedOnActionFilterAndPubCode("OnCreateChangeRequest",CurrentSubject,CurrentBody, CurrentPubCode,true);
        }
